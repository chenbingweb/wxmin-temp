...
Component({
  ...
  properties: {
    cityList: {
      ...
      //  console.log('country', this.country)
        ...
        this.selectCityObj = { code: this.cityList[0].city[0].code, name: this.cityList[0].city[0].name }
      }
    },
    shows: {
      type: Boolean,
  ...
  methods: {
    ...
    selectCity: function (e) {
      ...
      var myEventDetail = { selectCity: this.selectCityObj, codes: this.cityListCode }
      // detail对象，提供给事件监听函数
      var myEventOption = {
        bubbles: false,
        composed: false,
